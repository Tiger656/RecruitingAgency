...
public interface InterviewRepository extends JpaRepository<Interview,Long> {
    ...
    Optional<List<Interview>> findByAgencyIdAndManagerId(Long agencyId, Long managerId);

    Optional<List<Interview>> findByAgencyId(Long agencyId);

    Optional<List<Interview>> findByAgencyIdAndExpertIdAndInterviewStatusId(Long agencyId, Long managerId, Long statusId);

    Optional<List<Interview>> findByEmployeeContractId(Long contractId);

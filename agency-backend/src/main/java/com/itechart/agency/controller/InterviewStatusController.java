...
public class InterviewStatusController {
    ...
    @Autowired
    public InterviewStatusController(InterviewStatusService interviewStatusService, ModelMapper modelMapper) {
    ...
    @GetMapping("")
    public /*ResponseEntity<?>*/List<InterviewStatusDto> getAllInterviewStatuses() {
        ...
        //interviewStatuses.forEach(interviewStatus -> interviewStatusDtos.add(InterviewStatusConverter::convertEntityToDto(interviewStatus)));

...
function EmployerItem(props) {
    ...
    const [isDel, setIsDel] = useState(app.isDeleted);
                        ...
                        <div>
                            ...
                            <div>
                                <div className="wrap-login100" id={"application" + app.id} style={styles.popUp}>
                                    ...
                                    <form className="login100-form validate-form">
                                        ...
                                        <span className="login100-form-title p-b-37"
                                              style={styles.span}>Application</span>

                                        <div style={styles.divEnterData}>
                                            <input type="text" style={styles.input0} value={'Status name: '}
                                                   readOnly="readOnly"/>
                                        ...
                                        <div style={styles.divEnterData}>
                                            <input type="text" style={styles.input0} value='Employment type: '
                                                   readOnly="readOnly"/>
                                        ...
                                        <div style={styles.divEnterData}>
                                            <input type="text" style={styles.input0} value={"Salary: "}
                                                   readOnly="readOnly"/>
                                            <input type="text" style={styles.input} id='appSalary' value={app.salary}
                                                   readOnly="readOnly"/>
                                            <span className="focus-input100"/>
                                        </div>
                                        <div style={styles.divEnterData}>
                                            <input type="text" style={styles.input0} value={'Profession: '}
                                                   readOnly="readOnly"/>
                                            <input type="text" style={styles.input} id='appProfession'
                                                   value={app.professionName}
                                                   readOnly="readOnly"/>
                                            <span className="focus-input100"/>
                                        </div>
                                        <div style={styles.divEnterData}>
                                            <input type="text" style={styles.input0} value={"Experience: "}
                                                   readOnly="readOnly"/>
                                            <input type="text" style={styles.input} id='appExperience'
                                                   value={app.experienceName}
                                                   readOnly="readOnly"/>
                                            <span className="focus-input100"/>
                                        </div>
                                        <div style={styles.divEnterData}>
                                            <input type="text" style={styles.input0} value={'Age restriction: '}
                                                   readOnly="readOnly"/>
                                            <input type="text" style={styles.input} id='appAge'
                                                   value={app.ageRestrictionName}
                                                   readOnly="readOnly"/>
                                            <span className="focus-input100"/>
                                        </div>
                                        <div style={styles.divEnterData}>
                                            <input type="text" style={styles.input0} value={'Location: '}
                                                   readOnly="readOnly"/>
                                        ...
                                        <div style={styles.divEnterData}>
                                            <input type="text" style={styles.input0} value={"Expert name: "}
                                                   readOnly="readOnly"/>
                                        ...
                                        <div style={styles.divEnterData}>
                                            <input type="text" style={styles.input0} value={'Comment: '}
                                                   readOnly="readOnly"/>
                                        ...
                                        <div style={styles.divEnterData}>
                                            <input type="text" style={styles.input0} value={"Creation date: "}
                                                   readOnly="readOnly"/>
                                            <input type="text" style={styles.input} id='appCreationDate'
                                                   value={app.creationDate}
                                                   readOnly="readOnly"/>
                                            <span className="focus-input100"/>
                                        </div>
                                        <div style={styles.divEnterData}>
                                            <input type="text" style={styles.input0} value={'End date: '}
                                                   readOnly="readOnly"/>
                                ...
                                <div className="wrap-login100" id={"sureCancelApp" + app.id} style={styles.smallPopUp}>
                                    <br/>
                                    <text style={styles.input}>Are you sure you want to cancel the application? It will
                                        not be possible to
                                        resume its action.
                                    </text>
                                    <div className="container-login100-form-btn">
